...
$has_avatar   = asgard_has_gravatar( $author_email );
	...
	<div class="author-col-one mb-3 col-lg-3 col-md-3 col-sm-12">
		<div id="author-avatar" class="author-avatar d-flex align-items-start">
			...
			if ( ! empty( $has_avatar ) ) {
				...
				printf(
					'<span id="author-firstname" class="d-none">%1$s</span><span id="author-lastname" class="d-none">%2$s</span><div id="author-profile-img" class="rounded-circle bg-secondary position-relative author-img"><span class="h1 text-white inset-center"></span></div>',
