...
<li itemprop="review" itemtype="http://schema.org/Review" id="li-comment-<?php echo $review->ID; ?>">
	...
	<div id="comment-<?php echo $review->ID; ?>" class="comment_container">
		...
		<div class="comment-text" itemprop="itemReviewed">

			<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) : ?>

				<div itemprop="reviewRating" itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf( __( 'Rated %d out of 5', 'yith-woocommerce-advanced-reviews' ), $rating ) ?>">
